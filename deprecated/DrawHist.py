...
# 绘制直方图
def plot_histogram(pixel_array, window_left=0, window_right=16383):
    # 设置图形大小
    ...
    # 绘制直方图
    histogram, bins = np.histogram(pixel_array.flatten(), bins=16383, range=(window_left, window_right))
